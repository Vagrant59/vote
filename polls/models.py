...
class Teacher(models.Model):
    ...
    sex = models.BooleanField(default=True, verbose_name='性别', choices=SEX_OPTIONS)
    birth = models.DateField(verbose_name='出生日期')
    intro = models.CharField(max_length=1000, verbose_name='个人介绍')
    photo = models.ImageField(max_length=255, verbose_name='照片', blank=True, null=True, upload_to='static/images/')
